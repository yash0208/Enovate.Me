        ...
        f.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(gender1.equals("Not Selected")){
                    ...
                    Toast.makeText(EditProfile.this,"Please Enter Valid Name",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(Email.getText().toString())){
                    Toast.makeText(EditProfile.this,"Please Enter Valid Email",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(Number.getText().toString())){
                    Toast.makeText(EditProfile.this,"Please Enter Valid Number",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(Address.getText().toString())){
                    Toast.makeText(EditProfile.this,"Please Enter Valid Address",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(Pincode.getText().toString())){
                    Toast.makeText(EditProfile.this,"Please Enter Valid Pincode",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(dis.getText().toString())){
                    Toast.makeText(EditProfile.this,"Please Enter Valid Description",Toast.LENGTH_LONG).show();
                }
                else{
                    HashMap<Object,String> hashMap=new HashMap<>();
