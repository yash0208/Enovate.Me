...
public class History extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query1= FirebaseDatabase.getInstance().getReference().child("Culture").child("Feed");
        ...
        r.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Query query1= FirebaseDatabase.getInstance().getReference().child("Culture").child("Research");
                FirebaseRecyclerOptions<cul> option1 =
                        new FirebaseRecyclerOptions.Builder<cul>()
                                .setQuery(query1,cul.class)
                                .build();
        ...
        f.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                v.setTextColor(Color.parseColor("#ff515c6f"));
                Query query2= FirebaseDatabase.getInstance().getReference().child("Culture").child("Feed");
        ...
        v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    Query query3= FirebaseDatabase.getInstance().getReference().child("Culture").child("videos");
        ...
        FirebaseRecyclerOptions<cul> options =
                new FirebaseRecyclerOptions.Builder<cul>()
                        ...
                        .build();
        a4=new Adapter2(options);
        Query query2= FirebaseDatabase.getInstance().getReference().child("Culture").child("Research");
        FirebaseRecyclerOptions<cul> option2 =
                new FirebaseRecyclerOptions.Builder<cul>()
                        .setQuery(query2,cul.class)
                        .build();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i=new Intent(History.this,Home_Activity.class);
        startActivity(i);
    }
    ...
    public class Adapter2 extends FirebaseRecyclerAdapter<cul,Adapter2.viewholder>{
        ...
        @Override
        protected void onBindViewHolder(@NonNull viewholder viewholder, int i, @NonNull final cul cul) {
            Glide.with(getApplicationContext()).load(cul.getLink()).fitCenter().into(viewholder.image);
            viewholder.itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    if(Type.equals("Normal")){
                        Toast.makeText(History.this,"Join Us For Video Content",Toast.LENGTH_LONG).show();
                    }
                    else {
                        Intent intent=new Intent(History.this,Video_Player.class);
        ...
        protected void onBindViewHolder(@NonNull viewholder viewholder, int i, @NonNull final cul cul) {
            ...
            viewholder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                        ...
                        Intent intent=new Intent(History.this,ViewInfozine.class);
    ...
    public class Adapter extends FirebaseRecyclerAdapter<cul,Adapter.viewholder>{
        ...
        protected void onBindViewHolder(@NonNull viewholder viewholder, int i, @NonNull final cul cul) {
            ...
            viewholder.image.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent i1=new Intent(History.this,FullScreenImage.class);
