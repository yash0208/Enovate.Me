...
public class fieldwise_framwork extends AppCompatActivity {
    RecyclerView rec;
    Adapter a;
    String Name;
    TextView name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fieldwise_framwork);
        Intent i=getIntent();
        ...
        Query query= FirebaseDatabase.getInstance().getReference().child("Framworks").orderByChild("Field").equalTo(Name);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i=new Intent(fieldwise_framwork.this,frameworks.class);
        startActivity(i);
        ...
        protected void onBindViewHolder(@NonNull Adapter.viewholder viewholder, int i, @NonNull final tips_pic tips) {
            ...
            viewholder.im.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent i1=new Intent(fieldwise_framwork.this,FullScreenImage.class);
